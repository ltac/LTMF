...
class ind_f {
  ...
  class I_officer_F: I_Soldier_F {// CO and DC
    ...
    weapons[] = {IND_GLRIFLE};
    magazines[] = {IND_GLRIFLE_MAG,IND_GLRIFLE_MAG_HE,IND_GLRIFLE_MAG_SMOKE,IND_GLRIFLE_MAG_FLARE,IND_PISTOL_MAG,"HandGrenade:2","SmokeShell:2","SmokeShellGreen:2"};
  ...
  class I_Soldier_TL_F: I_Soldier_F {// FTL
    weapons[] = {IND_GLRIFLE};
    magazines[] = {IND_GLRIFLE_MAG,IND_GLRIFLE_MAG_HE,IND_GLRIFLE_MAG_SMOKE,IND_GLRIFLE_MAG_FLARE,"SmokeShellGreen:2","HandGrenade:2","SmokeShell:2","HandGrenade:1","SmokeShell:2"};
    backpackItems[] += {"ACE_key_west"};
