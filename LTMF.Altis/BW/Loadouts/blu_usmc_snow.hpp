/*
 * Description:
 * Loadout definition for USMC Arctic units
 *
 * Author:
 * BWMF
...
class blu_f {
	...
	#define WEST_RADIO_MANPACK "tf_rt1523g_black"
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_USMC_arctic"};  /// randomized
        vest[] = {"rhsusf_spc","MNP_Vest_USMC_2","MNP_Vest_USMC"}; /// randomized
        headgear[] = {"MNP_Helmet_USMC_arctic"}; /// randomized
