/*
 * Description:
 * Loadout definition for USMC Desert units
 *
 * Author:
 * BWMF
...
class blu_f {
    ...
    class B_Soldier_F {// rifleman
        ...
        headgear[] = {"rhsusf_mich_helmet_marpatd","rhsusf_mich_helmet_marpatd_alt","rhsusf_mich_helmet_marpatd_norotos","rhsusf_mich_helmet_marpatd_norotos_arc"}; /// randomized
