/*
 * Description:
 * Loadout definition for US Army OCP units
 *
 * Author:
 * BWMF
...
class blu_f {
    ...
    class B_Soldier_F {// rifleman
        ...
        vest[] = {"rhsusf_iotv_ocp","rhsusf_iotv_ocp_Rifleman","MNP_Vest_USMC"}; /// randomized
        headgear[] = {"rhsusf_ach_helmet_ocp","rhsusf_ach_helmet_ESS_ocp","rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_headset_ess_ocp","rhsusf_ach_helmet_camo_ocp"}; /// randomized
    ...
    class B_Soldier_TL_F: B_Soldier_F {// FTL
		vest[] = {"rhsusf_iotv_ocp_Teamleader","rhsusf_iotv_ocp_Grenadier"};
        weapons[] = {WEST_GLRIFLE};
