...
_m4glrnd_smokered = "1Rnd_SmokeRed_Grenade_shell";

//Attatchments
_m4_scope_1 = "RH_eotech553";	// Holosight
...
_silencer1 = _m4_silencer;	// 5.56 suppressor
_silencer2 = "muzzle_snds_H";	// 6.5 suppressor

_scope1 = _m4_scope_1;
_scope2 = _m4_scope_2;
_scope3 = "rhsusf_acc_LEUPOLDMK4_2";
...
_baseHelmet = ["rhsusf_ach_helmet_camo_ocp", "rhsusf_ach_helmet_ESS_ocp", "rhsusf_ach_helmet_headset_ess_ocp", "rhsusf_ach_helmet_headset_ocp", "rhsusf_ach_helmet_ocp"];
_baseGlasses = [];
...
_crewHelmet = ["rhsusf_ach_bare_tan_headset"];
...
_backpack = {
	...
	{
		#include "f_assignGear_usaf_b.sqf";
	};
};
