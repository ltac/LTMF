// F3 - Folk ARPS Assign Gear Script - Armed Forces of the Russian Federation
...
_silencer1 = "rhs_acc_tgpa";	// TGPA (Suppressor)
_silencer2 = "muzzle_snds_H";	// 6.5 suppressor

_scope1 = "rhs_acc_pkas";		// PK-AS (Reflex)
_scope2 = "rhs_acc_1p29";		// 1P29 (4x?)
_scope3 = "rhs_acc_pso1m2";		// PSO-1M2 (4x24 tele)
...
_glsmokegreen = "rhs_GRD40_White";
_glsmokered = "rhs_GRD40_White";
...
_baseHelmet = ["rhs_6b27m", "rhs_6b27m_ess", "rhs_6b27m_bala", "rhs_6b27m_ess_bala"];
_baseGlasses = [];
...
_heavyRig = ["rhs_6b23_6sh92_headset_mapcase"];
...
_sfhelmet = ["rhs_Booniehat_digi"];
_sfRig = ["rhs_digi_6b23_6sh92_vog_headset"];
_sfGlasses = [];
...
_backpack = {
	...
	{
		#include "f_assignGear_afrf_b.sqf";
	};
};
